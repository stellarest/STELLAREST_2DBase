...
namespace STELLAREST_2D
{
    /*
        ...
        // TODO : 개선 사항 
        lv.1 피해를 입을 때, 10%의 확률로 Elemental Shock를 발동시키고, 동시에 받게 되는 피해량 또한 10% 감소한다. (쿨타임 0초)
        Elemental Shock는 주변의 적에게 [n]만큼의 데미지를 입히고, 1초 동안 기절과 함께 4초 동안 30% 감속시킨다.

        lv.2 피해를 입을 때, 15%의 확률로 Elemental Shock를 발동시키고, 동시에 받게 되는 피해량 또한 15% 감소한다. (쿨타임 0초)
        Elemental Shock는 주변의 적에게 [n + (n * ratio)]만큼의 데미지를 입히고, 2초 동안 기절과 함께 4초 동안 40% 감속시킨다.

        lv.3 피해를 입을 때, 30%의 확률로 Elemental Shock를 발동시키고, 동시에 받게 되는 피해량 또한 30% 감소한다. (쿨타임 0초)
