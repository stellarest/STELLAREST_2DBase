    ...
    */
    ...
    public class PhantomSoul : UniqueSkill
    {
        ...
        public override void InitOrigin(CreatureController owner, SkillData data)
        {
            ...
            _child = this.Owner.SkillBook.ForceGetSkillMember(FixedValue.TemplateID.Skill.Unlock_PhantomKnightMastery_Elite_C1, 0).GetComponent<PhantomSoulChild>();
            _child.SetParent(this);
            this.Owner.SkillBook.LevelUp(FixedValue.TemplateID.Skill.Unlock_PhantomKnightMastery_Elite_C1);
        ...
        private IEnumerator CoActivatePhantomSoulChild_Temp()
        {
            ...
            this.Owner.SkillBook.Activate(FixedValue.TemplateID.Skill.Unlock_PhantomKnightMastery_Elite_C1);
            yield return null;
        }
