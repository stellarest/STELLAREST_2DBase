...
namespace STELLAREST_2D
{
    public class Utils
    {
        ...
        public static bool IsArrowMaster(CreatureController cc) => cc?.Stat.TemplateID == (int)FixedValue.TemplateID.Creatures.Reina_ArrowMaster;
        public static bool IsElementalArcher(CreatureController cc) => cc?.Stat.TemplateID == (int)FixedValue.TemplateID.Creatures.Reina_ElementalArcher;
        public static bool IsForestGuardian(CreatureController cc) => cc?.Stat.TemplateID == (int)FixedValue.TemplateID.Creatures.Reina_ForestGuardian;

        public static bool IsThief(CreatureController cc) => cc?.Stat.TemplateID == (int)FixedValue.TemplateID.Creatures.Kenneth_Thief;
        public static bool IsNinja(CreatureController cc) => cc?.Stat.TemplateID == (int)FixedValue.TemplateID.Creatures.Kenneth_Ninja;
