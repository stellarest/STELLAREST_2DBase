...
namespace STELLAREST_2D
{
    public static class Define
    {
        ...
        public enum SkillAnimationType { None = -1, US_Default = 100, US_Elite = 200, US_Elite_C1 = 201, US_Ultimate = 300, }
        ...
        {
            None = -1, MasteryPowerUp, AllSkillPowerUp, MovementSpeedUp, 
        }
        ...
        public static class FixedValue
        {
            ...
            public static class Find
            {
                ...
                public const string ANIM_PARAM_CREATURE_ATTACK_SPEED = "AttackSpeed";
                ...
                // Shield
                public const string INIT_SHIELD_HIT_BURST = "Hit_Burst";
            }
            ...
            public static class Numeric
            {
                ...
                public const float CREATURE_MAX_ATTACK_SPEED_PERCENTAGE = 1F;
                public const float CREATURE_MAX_ATTACK_ANIM_SPEED = 2F;
                public const float CREATURE_MIN_ATTACK_ANIM_SPEED = 0.4F;
                public const float PALADIN_ATTACK_MAX_COOLDOWN_REDUCTION = 0.25F;
                ...
                public const float INGAME_MAX_ARMOR_RATE = 0.85F; // temp (memo)

                // PlayerController
                public const float PLAYER_LOCAL_SCALE_X = 1.25F;
                public const float PLAYER_LOCAL_SCALE_Y = 1.25F;
                public const float PLAYER_MINIMUM_ENV_COLLECT_RANGE = 5F;
            ...
            public static class TemplateID
            {
                ...
                public enum Skill
                {
                    ...
                    US_Paladin_Default = 100100,
                    US_Paladin_Elite = 100103,  // Shield
                    US_Paladin_Ultimate = 100106, // Judgement

                    Knight_Unique_Mastery = 100200,
