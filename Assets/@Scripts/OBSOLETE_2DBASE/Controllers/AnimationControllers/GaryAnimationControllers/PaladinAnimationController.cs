...
namespace STELLAREST_2D
{
    public class PaladinAnimationController : PlayerAnimationController
    {
        public override void Init(CreatureController owner)
        {
            ...
            this.UPPER_MASTERY_ELITE_PLUS = Animator.StringToHash(FixedValue.Find.ANIM_PARAM_PLAYER_SHIELD);
            this.UPPER_MASTERY_ULTIMATE_PLUS = Animator.StringToHash("");
        }

        public override void SetAttackSpeed(float addSpeedRatio)
        {
            CreatureAnimator.SetFloat(CREATURE_ATTACK_SPEED, addSpeedRatio);
        }
    }
}
