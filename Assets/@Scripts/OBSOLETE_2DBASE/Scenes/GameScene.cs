...
namespace STELLAREST_2D
{
    public class GameScene : MonoBehaviour
    {
        ...
        private void StartLoaded()
        {
            ...
            PlayerController player = this.SpawnPlayer(FixedValue.TemplateID.Creatures.Gary_Paladin);
        ...
        private PlayerController SpawnPlayer(FixedValue.TemplateID.Creatures playerTemplateID) 
