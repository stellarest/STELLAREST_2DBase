                ...
                case Define.ObjectType.Player:
                    {
                        ...
                        pc.CreatureType = (FixedValue.TemplateID.Creatures)templateID;
                ...
                case Define.ObjectType.Monster:
                    {
                        switch (templateID)
                        {
                            case (int)FixedValue.TemplateID.Creatures.Chicken:
                                {
                                    GameObject go = Managers.Resource.Instantiate(Managers.Data.CreaturesDict[templateID].PrimaryLabels[0], pooling: isPooling);
                                    go.transform.position = spawnPos;
                                    ...
                                    chicken.CreatureType = (FixedValue.TemplateID.Creatures)templateID;
