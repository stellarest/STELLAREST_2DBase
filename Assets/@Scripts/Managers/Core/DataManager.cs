...
namespace STELLAREST_2D
{
    ...
    {
        public Dictionary<int, Data.PlayerStatData> PlayerStatDict { get; private set; } = new Dictionary<int, Data.PlayerStatData>();
        ...
        public void Init()
        {
            string loadPlayerStats = Define.PlayerData.Json.STATS;
            string loadMonstersData = Define.MonsterData.Json.MONSTERS_DATA;
            string loadSkillsData = Define.GameData.Json.SKILLS_DATA;

            PlayerStatDict = LoadJson<Data.PlayerDataLoader, int, Data.PlayerStatData>(loadPlayerStats).MakeDict();
            MonsterDict = LoadJson<Data.MonsterDataLoader, int, Data.MonsterData>(loadMonstersData).MakeDict();
            SkillDict = LoadJson<Data.SkillDataLoader, int, Data.SkillData>(loadSkillsData).MakeDict();
        }
