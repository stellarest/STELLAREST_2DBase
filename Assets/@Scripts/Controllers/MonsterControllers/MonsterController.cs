...
namespace STELLAREST_2D
{
    ...
    {
        public Define.MonsterType MonsterType { get; protected set; } = Define.MonsterType.None;
        ...
        private void FlipX(float flipX)
                => transform.localScale = new Vector2(_baseLocalScale.x * flipX, _baseLocalScale.y);
